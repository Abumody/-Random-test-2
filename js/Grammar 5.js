// Initialize when page loads
        ...
        function checkAnswers() {
            ...
            if (correctCount === totalQuestions) {
                feedback.textContent = "Excellent! You got all answers correct! Perfect tense mastery!";
            } else if (correctCount >= totalQuestions * 0.8) {
                feedback.textContent = "Great job! You have a good understanding of verb tenses.";
            } else if (correctCount >= totalQuestions * 0.6) {
                feedback.textContent = "Good effort! Review the incorrect answers to improve your tense usage.";
            } else {
                feedback.textContent = "You may need more practice with verb tenses. Review the rules and try again.";
            }
