// Initialize when page loads
        ...
        function checkAnswers() {
            ...
            if (correctCount === totalQuestions) {
                feedback.textContent = "Excellent! You got all answers correct! Perfect tense form mastery!";
            } else if (correctCount >= totalQuestions * 0.8) {
                feedback.textContent = "Great job! You have a good understanding of all tense forms.";
            } else if (correctCount >= totalQuestions * 0.6) {
                feedback.textContent = "Good effort! Review the incorrect answers to improve your tense form usage.";
            } else {
                feedback.textContent = "You may need more practice with tense forms. Review the rules and try again.";
            }
